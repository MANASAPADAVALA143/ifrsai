...
const inputClass = IFRS16_FILTER_INPUT_CLASS;
  ...
  return (
    <div className="bg-[#f9fafb] border border-[#e2e8f0] rounded-lg p-3 mb-3">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 mb-2">
        ...
        <div>
          <label className="block text-[10px] font-semibold text-[#64748b] uppercase tracking-wide mb-0.5">Lease Type</label>
        ...
        <div>
          <label className="block text-[10px] font-semibold text-[#64748b] uppercase tracking-wide mb-0.5">Status</label>
        ...
        <div>
          <label className="block text-[10px] font-semibold text-[#64748b] uppercase tracking-wide mb-0.5">Legal Entity</label>
